...
class RecommendationsControllerTest < ActionController::TestCase
  ...
  test "should create recommendation" do
    assert_difference('Recommendation.count') do
      post :create, recommendation: { category: @recommendation.category, description: @recommendation.description, imageUrl: @recommendation.imageUrl, location: @recommendation.location, title: @recommendation.title }
    end
  ...
  test "should update recommendation" do
    patch :update, id: @recommendation, recommendation: { category: @recommendation.category, description: @recommendation.description, imageUrl: @recommendation.imageUrl, location: @recommendation.location, title: @recommendation.title }
    assert_redirected_to recommendation_path(assigns(:recommendation))
  end
